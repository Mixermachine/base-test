...
public class CheckHelperFunctionsTest {
    ...
    @Before
    public void setup() {
        logger = Logger.getLogger(CheckHelperFunctions.class.getName());
        logs = new ArrayList<>();
    ...
    @Test
    public void logFailedcheckStepSimpleTest() {
        String testObject = "dc83f192-6cfe-4036-8f3d-089e6a9982a4";

        CheckHelperFunctions.logFailedCheckStep(logger, testObject);
    ...
    @Test
    public void logFailedcheckStepWithMessageTest() {
        String testObject = "cb7dcc36-c33e-430b-8262-fe5621661057";
        String message = "657c3cd6-1e74-4ced-ba95-d42e85ee86e7";

        CheckHelperFunctions.logFailedCheckStep(logger, testObject, message);
    ...
    @Test
    public void logFailedcheckStepWithExceptionTest() {
        ...
        CheckHelperFunctions.logFailedCheckStep(logger, testObject, exception);
    ...
    @Test
    public void logFailedcheckStepWithMessageAndExceptionTest() {
        ...
        CheckHelperFunctions.logFailedCheckStep(logger, testObject, message, exception);
